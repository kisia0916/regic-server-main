...
app.use(cors({
    origin: ["https://regic-instans-1.onrender.com","http://localhost:3000","http://localhost:1212"], // ReactアプリケーションのURL
...
export const io = new Server(server,{
    cors:{
        origin:["https://regic-instans-1.onrender.com","http://localhost:1212","http://localhost:3000"],
